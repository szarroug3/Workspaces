...
# devbox
alias db='docker run --rm -it -v $HOME/.ssh:/root/.ssh -v $HOME/.zsh_history:/root/.zsh_history -v /var/run/docker.sock:/var/run/docker.sock -v $PWD:$PWD --workdir $PWD -e AWS_ACCESS_KEY_ID -e AWS_SECRET_ACCESS_KEY -e GITHUB_TOKEN devbox'
